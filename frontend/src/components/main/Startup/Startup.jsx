            ...
            <div className="col-lg-12">
              <div className="breadcrumbs">
                <ul className="breadcrumbs__list">
                  ...
                  <li><Link to="#">Business Registrations</Link></li>
          ...
          <div className="row">
            <div className="col-md-9">
              <div className="top_left">
                <div className="top_img">
                  <img className="img-fluid" src="https://img.indiafilings.com/catalog/company-registration-india.png" alt="img" loading="lazy" />
                </div>
                ...
                <div className="top_main">
                  ...
                  <div className="gst_section">
                    <div className="invoicing">
                      <img className="img-fluid" src="https://img.indiafilings.com/catalog/ledgers_icon.png" alt="img" loading="lazy" />
                      <div>
                    ...
                    <div className="invoicing">
                      <img className="img-fluid" src="https://img.indiafilings.com/catalog/gstn-icon.png" alt="img" loading="lazy" />
                      <div>
                    ...
                    <div className="invoicing">
                      <img className="img-fluid" src="https://img.indiafilings.com/catalog/icici-icon.png" alt="img" loading="lazy" />
                      <div>
            ...
            <div className="col-md-3 top_right">
              <div className="card" style={{ width: "18rem" }}>
                <img src="https://img.indiafilings.com/catalog/personalised-quotes-if.png" className="card-img-top" alt="img" loading="lazy" />
      ...
      <section className="mt-5 mb-5">
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-3 mb-4 mb-md-0">
              <div className="card custom_card">
                <img src="https://img.indiafilings.com/catalog/company-registration-india.png" className="card-img-top" alt="img" loading="lazy" />
                <div className="card-body">
            ...
            <div className="col-md-3 mb-4 mb-md-0">
              <div className="card custom_card">
                <img src="https://img.indiafilings.com/catalog/opc-registration-india.webp" className="card-img-top" alt="img" loading="lazy" />
                <div className="card-body">
                  <p className="card-text"><span style={{ fontWeight: "600" }}>Company Registration</span></p>
                  <p className="card-text"><span style={{ color: "#007185" }}>Register your company in less than 7 days through a seamless.</span></p>
                  <p className="card-text">Market Price : <span style={{ textDecoration: "line-through", fontWeight: "500" }}>INR 7,899</span></p>
          ...
          <div className="row my-4">
            <div className="col-md-3 mb-4 mb-md-0">
              <div className="card custom_card">
                <img src="https://img.indiafilings.com/catalog/proprietorship-india.webp" className="card-img-top" alt="img" loading="lazy" />
                <div className="card-body">
                  <p className="card-text"><span style={{ fontWeight: "600" }}>Company Registration</span></p>
                  <p className="card-text"><span style={{ color: "#007185" }}>Register your company in less than 7 days through a seamless.</span></p>
                  <p className="card-text">Market Price : <span style={{ textDecoration: "line-through", fontWeight: "500" }}>INR 7,899</span></p>
            ...
            <div className="col-md-3 mb-4 mb-md-0">
              <div className="card custom_card">
                <img src="https://img.indiafilings.com/catalog/LLP-Registration.png" className="card-img-top" alt="img" loading="lazy" />
                <div className="card-body">
                  <p className="card-text"><span style={{ fontWeight: "600" }}>Company Registration</span></p>
                  <p className="card-text"><span style={{ color: "#007185" }}>Register your company in less than 7 days through a seamless.</span></p>
                  <p className="card-text">Market Price : <span style={{ textDecoration: "line-through", fontWeight: "500" }}>INR 7,899</span></p>
            ...
            <div className="col-md-3 mb-4 mb-md-0">
              <div className="card custom_card">
                <img src="https://img.indiafilings.com/catalog/Partnership-Registration.png" className="card-img-top" alt="img" loading="lazy" />
                <div className="card-body">
                  <p className="card-text"><span style={{ fontWeight: "600" }}>Company Registration</span></p>
                  <p className="card-text"><span style={{ color: "#007185" }}>Register your company in less than 7 days through a seamless.</span></p>
                  <p className="card-text">Market Price : <span style={{ textDecoration: "line-through", fontWeight: "500" }}>INR 7,899</span></p>
            ...
            <div className="col-md-3 mb-4 mb-md-0">
              <div className="card custom_card">
                <img src="https://img.indiafilings.com/catalog/indiafilings-India-Business-Setup.jpg" className="card-img-top" alt="img" loading="lazy" />
                <div className="card-body">
                  <p className="card-text"><span style={{ fontWeight: "600" }}>Company Registration</span></p>
                  <p className="card-text"><span style={{ color: "#007185" }}>Register your company in less than 7 days through a seamless.</span></p>
                  <p className="card-text">Market Price : <span style={{ textDecoration: "line-through", fontWeight: "500" }}>INR 7,899</span></p>
          ...
          <div className="row my-4">
            <div className="col-md-3 mb-4 mb-md-0">
              <div className="card custom_card">
                <img src="https://img.indiafilings.com/catalog/Nidhi-Company-india.png" className="card-img-top" alt="img" loading="lazy" />
                <div className="card-body">
                  <p className="card-text"><span style={{ fontWeight: "600" }}>Company Registration</span></p>
                  <p className="card-text"><span style={{ color: "#007185" }}>Register your company in less than 7 days through a seamless.</span></p>
                  <p className="card-text">Market Price : <span style={{ textDecoration: "line-through", fontWeight: "500" }}>INR 7,899</span></p>
            ...
            <div className="col-md-3 mb-4 mb-md-0">
              <div className="card custom_card">
                <img src="https://img.indiafilings.com/catalog/Producer-Company-india.png" className="card-img-top" alt="img" loading="lazy" />
                <div className="card-body">
                  <p className="card-text"><span style={{ fontWeight: "600" }}>Company Registration</span></p>
                  <p className="card-text"><span style={{ color: "#007185" }}>Register your company in less than 7 days through a seamless.</span></p>
                  <p className="card-text">Market Price : <span style={{ textDecoration: "line-through", fontWeight: "500" }}>INR 7,899</span></p>
          ...
          <div className="row">
            <div className="col-md-3">
              <div className="bank_card mb-4 mb-md-0">
                <img src="https://img.ledgers.cloud/assets/ICICI_Bank_Logo.svg" alt="img" style={{ marginBottom: "0.5rem" }} loading="lazy" />
            ...
            <div className="col-md-3">
              <div className="bank_card mb-4 mb-md-0">
                <img src="https://img.indiafilings.com/catalog/dbs_bank.svg" alt="img" style={{ marginBottom: "0.5rem" }} loading="lazy" />
                <p>Initial Funding INR 25,000</p>
                <div className="item">Zero Balance Account <i className="fa fa-check-circle tick"></i></div>
                <hr />
                <div className="item">Free IMPS/NEFT/RTGS <i className="fa fa-check-circle tick"></i></div>
            ...
            <div className="col-md-3">
              <div className="bank_card mb-4 mb-md-0">
                <img src="https://img.ledgers.cloud/assets/bank/Yes_Bank_Logo.svg" alt="img" style={{ marginBottom: "0.5rem" }} loading="lazy" />
                <p>Initial Funding INR 25,000</p>
                <div className="item">Zero Balance Account <i className="fa fa-check-circle tick"></i></div>
                <hr />
                <div className="item">Free IMPS/NEFT/RTGS <i className="fa fa-check-circle tick"></i></div>
            ...
            <div className="col-md-3">
              <div className="bank_card mb-4 mb-md-0">
                <img src="https://img.ledgers.cloud/assets/bank/Axis_Bank_logo.svg" alt="img" style={{ marginBottom: "0.5rem" }} loading="lazy" />
                <p>Initial Funding INR 25,000</p>
                <div className="item">Zero Balance Account <i className="fa fa-check-circle tick"></i></div>
                <hr />
                <div className="item">Free IMPS/NEFT/RTGS <i className="fa fa-check-circle tick"></i></div>
